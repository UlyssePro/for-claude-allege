...
interface CardClasseProps {
  classe: ClasseItem | null;
}

export function CardClasseEleve({ classe }: CardClasseProps) {
  return (
    <div className="w-full max-w-[270px] bg-[#111827] rounded-2xl overflow-hidden shadow-lg">
      ...
      <div className="px-6 pb-6 flex flex-wrap gap-2">
        {classe ? (
          <Badge className={`${getClasseColor(classe.label)} px-2 py-1 rounded text-xs font-medium`}>
            {classe.label}
          </Badge>
        ) : (
